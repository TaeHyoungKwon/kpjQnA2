...
public class KpjQnAApplication {
	...
	public Docket newsApi() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("kpjQnA").apiInfo(apiInfo()).select()
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("KpjQnA").description("Spring REST Sample with Swagger")
